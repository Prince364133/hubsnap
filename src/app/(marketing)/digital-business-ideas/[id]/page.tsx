...
export default function GuideDetailsPage() {
    ...
    useEffect(() => {
        const unsubscribe = onAuthStateChanged(auth, (u) => {
            setUser(u);
            // In a real app we would check if already saved
        });
        return () => unsubscribe();
    }, []);
                            ...
                            <Card className="p-6 border-slate-200 bg-slate-50/50 sticky top-32">
                                <div className="space-y-6">
                                    ...
                                    {guide.premium ? (
                                        ...
                                        <Button className="w-full h-12 text-lg font-bold bg-green-600 hover:bg-green-700 shadow-lg shadow-green-500/20">
                                            Start Reading
                                        </Button>
                                    )}
