        ...
        <div className="space-y-6">
            ...
            {loading ? (
                <div className="text-center py-12">
                    ...
                    <p className="mt-4 text-text-secondary">Loading guides...</p>
                </div>
            ) : filteredGuides.length === 0 ? (
                <div className="text-center py-12">
                    <p className="text-text-secondary">No guides found matching your criteria.</p>
                </div>
            ) : (
