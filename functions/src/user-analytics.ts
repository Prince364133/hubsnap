 ...
 */
export const aggregateUserActivity = onSchedule('every 1 hours', async (event) => {
 ...
 */
export const updateAdminStats = onSchedule('every 5 minutes', async (event) => {
 ...
 */
export const getUserActivityTimeline = onCall(async (request) => {
