...
exports.aggregateDashboardStats = void 0;
 ...
 */
exports.aggregateDashboardStats = (0, scheduler_1.onSchedule)('0 * * * *', async (event) => {
    ...
    await db.collection('dashboard_snapshots').add(Object.assign(Object.assign({}, dashboardStats), { timestamp: admin.firestore.Timestamp.now() }));
